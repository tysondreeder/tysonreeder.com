    ...
    <div class="Grid">
        <!-- <div class="Card">
          <div class="content">
            <h3>Mutual of Omaha.com 2017 Redesign</h3>
            <p>The 2017 redesign of Mutual of Omaha.com.</p>
            <div class="cta-container">
              <a href="http://bit.ly/2GYMAz2" title="Read the Mutual of Omaha.com 2017 Case Study" class="Button">Read the Case Study</a>
            </div>
          </div>
        </div> -->
        <div class="Card">
          <div class="content">
            <h3>MutualofOmaha.com Sticky Navigation Enhancement</h3>
        ...
        <div class="Card">
          <div class="content">
            <h3>Mutual of Omaha Digital Design System
            </h3>
        ...
        <div class="Card">
          <div class="content">
            <h3>Sales Reporting Web Application
            </h3>
